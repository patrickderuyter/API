...
{
    public LocalOpdracht()
    {
    }

    public LocalOpdracht(OpdrachtTypes type, OpdrachtStatuss status, string? opdrachtNummer, bool isOudeOpdracht, string? beginLocatieNr, string? beginLocatieNrDisplay, string? eindLocatieNr, string? eindLocatieNrDisplay, string? controleNummer, string? palletNummerVan, string? palletNummerNaar, int aantalColli, string? artikel, string? artikelNr, string? zonegroepNr, string? lastDrager, bool isBestemmingPickLocatie, bool isBestemmingAnderGebied, string? gebied, string? statusOmschrijving, string? inbehandelingDoorPincode, int opdrachtenAfgerond, int opdrachtenOpen, string? idnr, double gewicht, int opdrachtenOpenOrder, string? controleNummer2, PartijStatuss partijStatus)
    {
        Type = type;
        Status = status;
        OpdrachtNummer = opdrachtNummer;
        IsOudeOpdracht = isOudeOpdracht;
        BeginLocatieNr = beginLocatieNr;
        BeginLocatieNrDisplay = beginLocatieNrDisplay;
        EindLocatieNr = eindLocatieNr;
        EindLocatieNrDisplay = eindLocatieNrDisplay;
        ControleNummer = controleNummer;
        PalletNummerVan = palletNummerVan;
        PalletNummerNaar = palletNummerNaar;
        AantalColli = aantalColli;
        Artikel = artikel;
        ArtikelNr = artikelNr;
        ZonegroepNr = zonegroepNr;
        LastDrager = lastDrager;
        IsBestemmingPickLocatie = isBestemmingPickLocatie;
        IsBestemmingAnderGebied = isBestemmingAnderGebied;
        Gebied = gebied;
        StatusOmschrijving = statusOmschrijving;
        InbehandelingDoorPincode = inbehandelingDoorPincode;
        OpdrachtenAfgerond = opdrachtenAfgerond;
        OpdrachtenOpen = opdrachtenOpen;
        Idnr = idnr;
        Gewicht = gewicht;
        OpdrachtenOpenOrder = opdrachtenOpenOrder;
        ControleNummer2 = controleNummer2;
        PartijStatus = partijStatus;
    }
